...
def most_successful(df, sport):
    ...
    result = athlete_counts.head(15).merge(df, on='Name', how='left')
    result = result[['Name', 'count', 'Sport', 'region']].drop_duplicates('Name')
...
def most_successful_country_wise(df, country):
    ...
    result = athlete_counts.head(10).merge(df, on='Name', how='left')

    result = result[['Name', 'count', 'Sport']].drop_duplicates('Name')
    result.index = range(1, len(result) + 1)
