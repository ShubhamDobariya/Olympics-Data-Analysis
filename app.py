...
st.sidebar.image("https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Olympic_rings_without_rims.svg/800px-Olympic_rings_without_rims.svg.png")
...
if user_menu == 'Medal Tally':
    ...
    if selected_year == 'Overall' and selected_country == 'Overall':
        st.title("Overall Medal Tally In The Olympics")
    if selected_year != 'Overall' and selected_country == 'Overall':
...
if user_menu == 'Country-wise Analysis':
    ...
    selected_country = st.sidebar.selectbox("Select a Country", country_list, default_index)
...
if user_menu == 'Athlete-wise Analysis':
    ...
    st.title("Age Distribution by Medal Type (Gold, Silver, Bronze, Overall)")
    st.plotly_chart(fig)
    ...
    st.title("Age Distribution of Gold Medalists Across Different Sports")
    st.plotly_chart(fig)
    ...
    st.title("Height vs. Weight Distribution of Athletes")
    selected_sport = st.selectbox("Select a Sport", sport_list)
